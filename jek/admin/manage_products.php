...
if($_SERVER['REQUEST_METHOD'] === 'POST'){
    if(isset($_POST['create'])){
        ...
        mysqli_query($conn, "INSERT INTO products (name, price, description, stock, image) VALUES ('$name',$price,'$desc',$stock," . ($image ? "'$image'" : "NULL") . ")");
    ...
    if(isset($_POST['update'])){
        ...
        mysqli_query($conn, "UPDATE products SET name='$name', price=$price, description='$desc', stock=$stock $imageSql WHERE id=$id");
