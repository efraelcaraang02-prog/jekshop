...
$products = mysqli_query($conn, "SELECT * FROM products ORDER BY id ASC LIMIT 8");

// Count cart items
$cart_count = 0;
if(isset($_SESSION['user_id'])){
    $user_id = $_SESSION['user_id'];
    $cart_count = mysqli_fetch_assoc(mysqli_query($conn, "SELECT SUM(quantity) as cart_count FROM cart WHERE user_id=$user_id"))['cart_count'] ?? 0;
}
?>
<!DOCTYPE html>
<html lang="en">
...
.badge-cart { background:red; color:#fff; border-radius:50%; padding:3px 7px; font-size:0.9em; position:relative; top:-10px; left:-5px; }
...
<div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            <li class="nav-item"><a class="nav-link active" href="home.php"><i class="fa-solid fa-house"></i> Home</a></li>
            <li class="nav-item"><a class="nav-link" href="shop.php"><i class="fa-solid fa-bag-shopping"></i> Shop</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-list"></i> Categories</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-info-circle"></i> About</a></li>
            <li class="nav-item"><a class="nav-link" href="#"><i class="fa-solid fa-phone"></i> Contact</a></li>
        </ul>
        <ul class="navbar-nav ms-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="dashboard.php"><i class="fa-solid fa-user"></i> <?= $user_name ?></a>
            </li>
            <?php else: ?>
